      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                <li class="active"><a href="#"> <i class="icon-home"></i>Home </a></li>
                    ...
                    <li><a href="{{ route('admin.adddrink') }}">Add Drink</a></li>
                    <li><a href="{{ route('admin.showfood') }}">View Food</a></li>
                    <li><a href="{{ route('admin.showdrink') }}">View Drink</a></li>
                    <li><a href="{{ route('admin.vieworders') }}">Food Orders</a></li>
                    <li><a href="{{ route('admin.vieworderss') }}">Drink Orders</a></li>
