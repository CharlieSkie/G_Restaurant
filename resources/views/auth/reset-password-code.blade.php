        ...
        <div style="width: 100%; max-width: 420px; background: rgba(25, 25, 25, 0.95); 
            ...
            <form method="POST" action="{{ route('password.reset-with-code') }}">
                ...
                <div style="margin-bottom: 1.5rem;">
                    <x-label for="code" value="{{ __('Verification Code') }}" style="color: #e0c97f; font-size: 14px;" />
                    <x-input 
                        id="code" 
                        type="text" 
                        name="code" 
                ...
                <!-- New Password -->
                <div style="margin-bottom: 1.5rem;">
                    <x-label for="password" value="{{ __('New Password') }}" style="color: #e0c97f; font-size: 14px;" />
                    <x-input 
                        id="password" 
                        type="password" 
                        name="password" 
