...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav class="custom-navbar navbar navbar-expand-lg navbar-dark fixed-top" data-spy="affix" data-offset-top="10">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav">  
                ...
                @auth
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="cartDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Cart</a>
                    <div class="dropdown-menu" aria-labelledby="cartDropdown">
                        <a class="dropdown-item" href="{{ route('food.cart') }}">Food Cart</a>
                        <a class="dropdown-item" href="{{ route('drink.cart') }}">Drink Cart</a>
                    </div>
                </li>
                <li class="nav-item">
    ...
    <!-- show cart section -->
    <div style="margin-top: 70px; " class="containaer-fluid bg-dark text-light py-5 text-center wow fadeIn">
        @yield('show_cart')
    </div>
    <div style="margin-top: 50px; " class="containaer-fluid bg-dark text-light py-5 text-center wow fadeIn">
        @yield('show_cart1')
    </div>
...
We believe that good food brings people together — that’s why we take pride in serving dishes that remind you of home, crafted with care and inspired by Filipino flavors.

From our signature pork adobo and crispy sisig to refreshing halo-halo desserts, every bite tells a story of tradition and taste. Whether you're dining in with family, hanging out with friends, or grabbing a quick bite, our goal is to make you feel right at home.

Come experience the warm hospitality, cozy atmosphere, and delicious food that make Foodie Resto more than just a place to eat — it’s where memories are made.</p>
                    </div>
                </div>
            </div>
        </div>
